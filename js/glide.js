...
! function (t, e) {
  ...
  var p = function () {
    ...
    m = function () {
      function o(t) {
        var e, n, i, r = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {};
        u(this, o), this._c = {}, this._e = new p, this.disabled = !1, this.selector = t, this.settings = (i = a({}, e = s, n = r), n.hasOwnProperty("classes") && (i.classes = a({}, e.classes, n.classes), n.classes.hasOwnProperty("direction") && (i.classes.direction = a({}, e.classes.direction, n.classes.direction))), i), this.index = this.settings.startAt
      }
      return i(o, [{
        key: "mount",
        value: function () {
  ...
  var P = {
    Html: function (e, t) {
      ...
      return h(n, "root", {
        ...
        set: function (t) {
          o(t) && (t = document.querySelector(t)), _(t) && (n._r = t)
        }
      }), h(n, "track", {
        get: function () {
          return n._t
    ...
    Translate: function (r, o, s) {
      var u = {
        set: function (t) {
          var n, i, e = (n = r, i = o, {
            mutate: function (t) {
              for (var e = 0; e < x.length; e++) t = x[e](n, i).modify(t);
              return t
            }
          }).mutate(t);
    ...
    Peek: function (n, t, e) {
      ...
      return h(i, "value", {
        ...
        set: function (t) {
          c(t) ? (t.before = v(t.before), t.after = v(t.after)) : t = v(t), i._v = t
        }
      }), h(i, "reductor", {
        get: function () {
          var t = i.value,
    ...
    Gaps: function (e, o, t) {
      var n = {
        ...
        apply: function (t) {
          for (var e = 0, n = t.length; e < n; e++) {
            var i = t[e].style,
              r = o.Direction.value;
            i[b[r][0]] = 0 !== e ? this.value / 2 + "px" : "", e !== t.length - 1 ? i[b[r][1]] = this.value / 2 + "px" : i[b[r][1]] = ""
          }
        },
        remove: function (t) {
          for (var e = 0, n = t.length; e < n; e++) {
      ...
      return h(n, "value", {
        ...
        n.mount()
      }), t.on(["build.after", "update"], y(function () {
    ...
    Clones: function (s, u, t) {
      var e = {
        mount: function () {
          this.items = [], s.isType("carousel") && (this.pattern = this.map(), this.items = this.collect())
        },
        map: function () {
          var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : [],
            e = s.settings.perView,
            n = u.Html.slides.length;
          if (0 !== n)
            for (var i = 0; i < Math.max(1, Math.floor(e / n)); i++) {
              for (var r = 0; r <= n - 1; r++) t.push("" + r);
              for (var o = n - 1; 0 <= o; o--) t.unshift("-" + o)
            }
          return t
        },
        collect: function () {
          for (var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : [], e = this.pattern, n = 0; n < e.length; n++) {
            var i = u.Html.slides[Math.abs(e[n])].cloneNode(!0);
            i.classList.add(s.settings.classes.cloneSlide), t.push(i)
          }
          return t
        },
        append: function () {
          for (var t = this.items, e = this.pattern, n = 0; n < t.length; n++) {
            var i = t[n];
            i.style.width = u.Sizes.slideWidth + "px", "-" === e[n][0] ? u.Html.wrapper.insertBefore(i, u.Html.slides[0]) : u.Html.wrapper.appendChild(i)
          }
        },
        remove: function () {
          for (var t = this.items, e = 0; e < t.length; e++) u.Html.wrapper.removeChild(t[e])
        }
      };
      return h(e, "grow", {
        get: function () {
          return (u.Sizes.slideWidth + u.Gaps.value) * e.items.length
        }
      }), t.on("update", function () {
        e.remove(), e.mount(), e.append()
      }), t.on("build.before", function () {
        s.isType("carousel") && e.append()
      }), t.on("destroy", function () {
        e.remove()
      }), e
    },
    ...
    Build: function (n, i, t) {
      var e = {
        ...
        activeClass: function () {
          ...
          t.classList.add(e.activeSlide), w(t).forEach(function (t) {
      ...
      var t = {
        ...
        calculate: function () {
          var t = this.move,
            ...
            n = t.steps,
            i = t.direction,
            r = "number" == typeof v(n) && 0 !== v(n);
          switch (i) {
            case ">":
              ">" === n ? o.index = e : this.isEnd() ? (o.isType("slider") && !o.settings.rewind || (this._o = !0, o.index = 0), s.emit("run.end", t)) : r ? o.index += Math.min(e - o.index, -v(n)) : o.index++;
              break;
            case "<":
              "<" === n ? o.index = 0 : this.isStart() ? (o.isType("slider") && !o.settings.rewind || (this._o = !0, o.index = e), s.emit("run.start", t)) : r ? o.index -= Math.min(o.index, v(n)) : o.index--;
              break;
            case "=":
              o.index = n
          }
    ...
    Swipe: function (c, l, f) {
        ...
        t = {
          ...
          start: function (t) {
            if (!n && !c.disabled) {
              ...
              d = null, h = v(e.pageX), p = v(e.pageY), this.bindSwipeMove(), this.bindSwipeEnd(), f.emit("swipe.start")
            }
          },
          move: function (t) {
            if (!c.disabled) {
              var e = c.settings,
                ...
                u = Math.sqrt(o + s),
                a = Math.sqrt(s);
              if (180 * (d = Math.asin(a / u)) / Math.PI < e.touchAngle && l.Move.make(i * parseFloat(e.touchRatio)), !(180 * d / Math.PI < e.touchAngle)) return !1;
              t.stopPropagation(), t.preventDefault(), l.Html.root.classList.add(e.classes.dragging), f.emit("swipe.move")
            }
          },
          end: function (t) {
            if (!c.disabled) {
              var e = c.settings,
                ...
                r = n.pageX - h,
                o = 180 * d / Math.PI,
                s = Math.round(r / l.Sizes.slideWidth);
              this.enable(), i < r && o < e.touchAngle ? (e.perTouch && (s = Math.min(s, v(e.perTouch))), l.Direction.is("rtl") && (s = -s), l.Run.make(l.Direction.resolve("<" + s))) : r < -i && o < e.touchAngle ? (e.perTouch && (s = Math.max(s, -v(e.perTouch))), l.Direction.is("rtl") && (s = -s), l.Run.make(l.Direction.resolve(">" + s))) : l.Move.make(), l.Html.root.classList.remove(e.classes.dragging), this.unbindSwipeMove(), this.unbindSwipeEnd(), f.emit("swipe.end")
            }
          },
          bindSwipeStart: function () {
            var t = c.settings;
            t.swipeThreshold && e.on(O[0], l.Html.wrapper, this.start.bind(this)), t.dragThreshold && e.on(O[1], l.Html.wrapper, this.start.bind(this))
          },
          unbindSwipeStart: function () {
            e.off(O[0], l.Html.wrapper), e.off(O[1], l.Html.wrapper)
          },
          bindSwipeMove: function () {
            e.on(A, l.Html.wrapper, y(this.move.bind(this), c.settings.throttle))
          },
          unbindSwipeMove: function () {
            e.off(A, l.Html.wrapper)
          },
          bindSwipeEnd: function () {
            e.on(M, l.Html.wrapper, this.end.bind(this))
          },
          unbindSwipeEnd: function () {
            e.off(M, l.Html.wrapper)
          },
          touches: function (t) {
      ...
      return f.on("build.after", function () {
        l.Html.root.classList.add(c.settings.classes.swipeable)
      }), f.on("destroy", function () {
        t.unbindSwipeStart(), t.unbindSwipeMove(), t.unbindSwipeEnd(), e.destroy()
      }), t
    },
      ...
      var n = new S,
        r = {
          ...
          addClass: function (t) {
            var e = i.settings,
              n = t[i.index];
            n.classList.add(e.classes.activeNav), w(n).forEach(function (t) {
    ...
    Autoplay: function (e, n, t) {
      ...
      return h(r, "time", {
        get: function () {
          ...
          return v(t || e.settings.autoplay)
        }
    ...
    Breakpoints: function (t, e, n) {
      ...
      return a(r, u.match(o)), i.on("resize", window, y(function () {
        a(r, u.match(o))
  ...
  return function (t) {
    function e() {
      return u(this, e), r(this, (e.__proto__ || Object.getPrototypeOf(e)).apply(this, arguments))
    }
    return function (t, e) {
      ...
      value: function () {
        ...
        }(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "mount", this).call(this, a({}, P, t))
      }
    }]), e
  }()
});